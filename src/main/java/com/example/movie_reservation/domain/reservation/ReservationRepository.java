...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    @Query(value = "select new com.example.movie_reservation.controller.reservation.dto.PopularMovieResponseDto(r.screening.movie, count(r.screening.movie.title)) " +
            "from Reservation r " +
            "join r.screening " +
