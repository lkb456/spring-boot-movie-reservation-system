...
class SeatServiceTest {
    ...
    String fileContent = "[A열 - 1, A열 - 2, A열 - 3, A열 - 4, A열 - 5, A열 - 6, A열 - 7, A열 - 8, A열 - 9, A열 - 10, A열 - 11, A열 - 12, A열 - 13, A열 - 14, A열 - 15, A열 - 16, A열 - 17, A열 - 18, A열 - 19, A열 - 20]\n" +
    ...
    void files_lines() throws URISyntaxException, IOException {
        String file = "src/main/resources/static/seat/position.txt";
